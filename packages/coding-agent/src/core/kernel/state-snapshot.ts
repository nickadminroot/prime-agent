...
def _prime_agent_snapshot_state():
    ...
    # rlm, asyncio, and the q helper are re-created/re-injected by the kernel
    # bootstrap on every start; never snapshot them.
    always_skip = {"rlm", "asyncio", "q", "In", "Out", "get_ipython", "exit", "quit", "open"}
